# Lab Week 4 - File Exploration & Text Analysis from the Command Line

Discuss with your group:

![Image](assets/mouse_escape_vehicle.png)
...
_`_`patterns,`>`redirection,`wc`, and `sort`:
...
- Accept queries of the form `?title='<some string>'`. This should return all
  the file paths where the given string is part of the _path_ of the file
