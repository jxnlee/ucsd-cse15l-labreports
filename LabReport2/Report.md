...
- Here is the code I wrote for String Server:
  ![String Server Code](media/StringServerCodeSS.png)
...
- My first change to the URL happens when I append `/add-message?s=Hello World!` to the root path of the URL, this is what I now see on the page after making this change: ![String Server Message 1](media/StringServerAddMsg1SS.png)
...
- My second change to the URL happens when I change the query to `/add-message?s=My name is Jeffrey`, this is what I now see on the page after making this change: ![String Server Message 2](media/StringServerAddMsg2SS.png)
...
- After running the two JUnit tests, here are the produced symptoms from the bug in the program:
  ![Symptom Output](media/BugSymptomSS.png)
...
_Note for Lab Report Resubmission: I have saved and resubmitted my lab Report in the corrected format such that the link appears in the bottom footer_
